...
describe('product price decorator', function () {
    var price = proxyquire('../../../../../../cartridges/app_storefront_base_composable/cartridge/models/product/decorators/price', {
        '*/cartridge/scripts/factories/price': {
            getPrice: function () { return 'Product Price'; }
        },
        '../../../../../../cartridges/app_storefront_base_composable/cartridge/models/product/decorators/price': {
