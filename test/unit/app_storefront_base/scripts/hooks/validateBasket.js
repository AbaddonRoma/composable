...
describe('validate basket', function () {
    var validateBasketHook = proxyquire('../../../../../cartridges/app_storefront_base_composable/cartridge/scripts/hooks/validateBasket', {
        'dw/web/Resource': {
            msg: function (param) {
                return param;
            }
        },
        '*/cartridge/scripts/helpers/basketValidationHelpers': proxyquire('../../../../../cartridges/app_storefront_base_composable/cartridge/scripts/helpers/basketValidationHelpers', {
            ...
            '*/cartridge/scripts/util/collections': proxyquire('../../../../../cartridges/app_storefront_base_composable/cartridge/scripts/util/collections', {
