...
describe('Reporting URLs', function () {
    var reportingUrls = proxyquire('../../../../cartridges/app_storefront_base_composable/cartridge/scripts/reportingUrls', {
        'dw/util/StringUtils': {
        ...
        '*/cartridge/scripts/helpers/formatHelpers': proxyquire('../../../../cartridges/app_storefront_base_composable/cartridge/scripts/helpers/formatHelpers', {
            'dw/util/StringUtils': {
                formatNumber: function () {
                    return 'formatted number';
                }
