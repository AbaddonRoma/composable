...
function proxyModel() {
    return proxyquire('../../../cartridges/app_storefront_base_composable/cartridge/scripts/checkout/checkoutHelpers', {
        'server': server,
        ...
        '*/cartridge/scripts/formErrors': require('../../../cartridges/app_storefront_base_composable/cartridge/scripts/formErrors')
    });
}
